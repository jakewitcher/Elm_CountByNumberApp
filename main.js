...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{current: 0, selected: 0, userInput: 0},
		...
		switch (msg.$) {
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{current: 0, selected: model.userInput, userInput: 0}),
					elm$core$Platform$Cmd$none);
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('The \"Count By\" App')
							])),
						A2(
						elm$html$Html$div,
						_List_Nil,
							...
							[
								...
								_List_fromArray(
									[
										...
										(!model.userInput) ? '' : elm$core$String$fromInt(model.userInput)),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text(
										(!model.selected) ? 'Select a number to get started!' : ('You\'ve chosen to count by ' + (elm$core$String$fromInt(model.selected) + 's')))
									]))
							])),
						A2(
						elm$html$Html$div,
